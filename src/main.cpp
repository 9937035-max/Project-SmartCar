...
case 0xB946FF00: myCar.Move(Forward, 155); break;
// Press "up" button to move forward
case 0xEA15FF00: myCar.Move(Backward, 155); break;
// Press "down" button to move backward
case 0xBB44FF00: myCar.Move(Contrarotate, 155); break;
// Press "left" button to turn left
case 0xBC43FF00: myCar.Move(Clockwise, 155); break;
// Press "right" button to turn right
case 0xE916FF00: myCar.Move(Move_Left, 155); break;
// Press button "1" to move left
case 0xF20DFF00: myCar.Move(Move_Right, 155); break;
